...
export default defineConfig({
	...
	integrations: [
						...
						items: [
        {
          label: "操作系统",
          items: [
          { slug: "kb/考研/操作系统/第1章-计算机系统概述" },
          { slug: "kb/考研/操作系统/第2章-进程与线程" },
          { slug: "kb/考研/操作系统/第3章-内存管理" },
          { slug: "kb/考研/操作系统/第4章-文件管理" },
          { slug: "kb/考研/操作系统/第5章-输入输出io管理" },
          ],
        },
        {
          label: "计算机网络",
          items: [
          { slug: "kb/考研/计算机网络/第1章-计算机网络体系结构" },
          { slug: "kb/考研/计算机网络/第2章-物理层" },
          { slug: "kb/考研/计算机网络/第3章-数据链路层" },
          { slug: "kb/考研/计算机网络/第4章-网络层" },
          { slug: "kb/考研/计算机网络/第5章-传输层" },
          { slug: "kb/考研/计算机网络/第6章-应用层" },
          ],
        },
        {
          label: "计算机组成原理",
          items: [
          { slug: "kb/考研/计算机组成原理/第1章-计算机系统概述" },
          { slug: "kb/考研/计算机组成原理/第2章-数据的表示和运算" },
          { slug: "kb/考研/计算机组成原理/第3章-存储系统" },
          { slug: "kb/考研/计算机组成原理/第4章-指令系统" },
          { slug: "kb/考研/计算机组成原理/第5章-中央处理器" },
          { slug: "kb/考研/计算机组成原理/第6章-总线" },
          { slug: "kb/考研/计算机组成原理/第7章-输入输出系统" },
          ],
        },
        {
          label: "数据结构",
          items: [
          { slug: "kb/考研/数据结构/第1章-绪论" },
          { slug: "kb/考研/数据结构/第2章-线性表" },
          { slug: "kb/考研/数据结构/第3章-栈队列和数组" },
          { slug: "kb/考研/数据结构/第4章-串" },
          { slug: "kb/考研/数据结构/第5章-树与二叉树" },
          { slug: "kb/考研/数据结构/第6章-图" },
          { slug: "kb/考研/数据结构/第7章-查找" },
          { slug: "kb/考研/数据结构/第8章-排序" },
          ],
        },
						],
					},
