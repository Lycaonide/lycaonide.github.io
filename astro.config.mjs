...
const kbSidebar = [
	{
		label: "知识库",
		items: [{ label: "知识库首页", link: "/kb/" }, ...kbScan(__kbDir, "kb")],
	},
];
	...
	integrations: [
		...
		starlight({
			...
			disable404Route: true,
						sidebar: kbSidebar,
// 顶栏右侧链接回博客
			social: [{ icon: "external", label: "返回", href: "/" }],
			components: {
				...
				},
			{
				tag: "script",
				content:
					"(function(){function f(){if(location.pathname.indexOf('/kb/')!==0)return;document.querySelectorAll('a').forEach(function(a){var h=a.getAttribute('href')||'';if(h.charAt(0)==='/'&&h.indexOf('//')!==0)a.setAttribute('data-no-swup','')})}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',f);else f();})();",
				},
			],
		}),
	],
